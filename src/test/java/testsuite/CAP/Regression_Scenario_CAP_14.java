...
public class Regression_Scenario_CAP_14
    ...
    public void Regression_Scenario_CAP_14_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_14_Test_Datafile";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CAP_14_Transaction_001_NBQUNBIS")
    public void Regression_Scenario_CAP_14_Transaction_002_ERRC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_14_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        testDataAsMap = utils.excelFileUtil().getExcelDataAsMapWithMultipleValues(excelFilePath, "ERRC");
        ...
        {
            whileViewing().theCMPLoginPage().theUser_().logsIntoPolicyDecisions(utils.configReader().getURL(), testDataAsMap.get("userNameTxt").get(0), testDataAsMap.get("passwordTxt").get(0));
            sanNumber = whileViewing().theCMPHomePage().theUser_().performActionsOnPolicy(testDataAsMap,"ERRC",sanNumber);
