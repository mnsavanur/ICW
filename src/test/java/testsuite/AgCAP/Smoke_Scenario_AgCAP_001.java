...
public class Smoke_Scenario_AgCAP_001
    ...
    public void Smoke_Scenario_AgCAP_01_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Smoke_Scenario_AgCAP_01_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            //whileViewing().theCapitalAssetPage().theUser_().enterAgCAPPolicyDetail(testDataAsMap);
            whileViewing().theAgCapPage().theUser_().enterAgCAPPolicyDetail(testDataAsMap);
