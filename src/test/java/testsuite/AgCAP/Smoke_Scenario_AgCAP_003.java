...
public class Smoke_Scenario_AgCAP_003
    ...
    public void Smoke_Scenario_CAP_03_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Smoke_Scenario_CAP_03_Test_Datafile";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Smoke_Scenario_CAP_03_Transaction_001_NBQUNBIS" )
    public void Smoke_Scenario_CAP_03_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Smoke_Scenario_CAP_03_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Smoke_Scenario_CAP_03_Transaction_002_PCNM")
    public void Smoke_Scenario_CAP_03_Transaction_03_PCNT() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Smoke_Scenario_CAP_03_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
