...
public class Regression_Scenario_GL_020
    ...
    public void Regression_Scenario_Transaction_020_NBQU() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQU";
        excelFileName = "GL_Regression_20";
    ...
    @Test(enabled = true, priority = 1, dependsOnMethods = "Regression_Scenario_Transaction_020_NBQU")
    public void Regression_Scenario_Transaction_020_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        excelFileName = "GL_Regression_20";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_Transaction_020_CANC")
    public void Regression_Scenario_Transaction_020_REISSUE() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        excelFileName = "GL_Regression_20";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
