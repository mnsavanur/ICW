...
public class Regression_Scenario_GL_019
    ...
    public void Regression_Scenario_Transaction_015_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "GL_Regression_19";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_Transaction_015_NBQUNBIS")
    public void Regression_Scenario_Transaction_02_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_19";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_Transaction_02_CANC")
    public void Regression_Scenario_Transaction_03_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_19";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    public void afterMethod(ITestResult testResult) throws ParserConfigurationException, InvalidFormatException, SAXException, IOException {
        ...
        scenarioName = scenarioName.replace("Regression", "");
