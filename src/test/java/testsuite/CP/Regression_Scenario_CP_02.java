...
public class Regression_Scenario_CP_02
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_02_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_02";
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theLocationsPage().theUser_().CPOverrides(testDataAsMap);
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CP_02_Transaction_01_NBQUNBIS")
    public void Regression_Scenario_CP_02_Transaction_02_CANC() throws Exception {
        excelFileName = "Regression_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_CP_02_Transaction_02_CANC")
    public void Regression_Scenario_CP_02_Transaction_03_CARS() throws Exception {
        excelFileName = "Regression_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
