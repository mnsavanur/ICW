...
public class Regression_Scenario_CP_05
    ...
    public void Regression_Scenario_CP_05_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_05";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_05_Transaction_01_NBQUNBIS" )
    public void Regression_Scenario_CP_05_Transaction_02_PCNM() throws Exception {
        excelFileName = "Regression_Scenario_CP_05";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
