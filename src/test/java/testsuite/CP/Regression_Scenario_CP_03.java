...
public class Regression_Scenario_CP_03
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_03_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_03";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CP_03_Transaction_01_NBQUNBIS")
    public void Regression_Scenario_CP_03_Transaction_02_REWR() throws Exception {
        excelFileName = "Regression_Scenario_CP_03";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_CP_03_Transaction_02_REWR")
    public void Regression_Scenario_CP_03_Transaction_03_MODIREWR() throws Exception {
        excelFileName = "Regression_Scenario_CP_03";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
