...
public class Regression_Scenario_CP_19
        extends TestFramework_Initializer implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_19_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_19";
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theGeneralLiabilityPage().theUser_().CPGL_OptCoverage(testDataAsMap);
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CP_19_Transaction_01_NBQUNBIS")
    public void Regression_Scenario_CP_19_Transaction_02_CANC() throws Exception {
        excelFileName = "Regression_Scenario_CP_19";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_CP_19_Transaction_02_CANC")
    public void Regression_Scenario_CP_19_Transaction_03_CARS() throws Exception {
        excelFileName = "Regression_Scenario_CP_19";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
