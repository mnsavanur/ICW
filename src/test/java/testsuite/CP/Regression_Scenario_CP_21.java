...
public class Regression_Scenario_CP_21
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_21_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_21";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().thePropertyPage().theUser_().addOptionalcoverages(testDataAsMap);
            ...
            whileViewing().theAdditionalInterests().theUser_().CPAddInterest(testDataAsMap);
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_21_Transaction_01_NBQUNBIS" )
        public void Regression_Scenario_CP_21_Transaction_02_PCNM1() throws Exception {
        excelFileName = "Regression_Scenario_CP_21";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            sanNumber = whileViewing().theCommonInfoPage().theUser_().fetchSan();
            whileViewing().thePropertyPage().theUser_().enterPropertyPolicyInfo(testDataAsMap);
            //whileViewing().theLocationsPage().theUser_().CPLocationInfoPCNM(testDataAsMap);
            //whileViewing().theLocationsPage().theUser_().CPLocationInfo(testDataAsMap);
            //whileViewing().theLocationsPage().theUser_().CPCoverages(testDataAsMap);
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
    ...
    @Test(enabled = true,  priority = 2, dependsOnMethods = "Regression_Scenario_CP_21_Transaction_02_PCNM1" )
    public void Regression_Scenario_CP_21_Transaction_03_PCNM2() throws Exception {
        excelFileName = "Regression_Scenario_CP_21";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
