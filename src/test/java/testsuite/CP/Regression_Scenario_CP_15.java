...
public class Regression_Scenario_CP_15
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_15_Transaction_01_NBIS() throws Exception {
        initialTransactionName = "NBIS";
        excelFileName = "Regression_Scenario_CP_15";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_15_Transaction_01_NBIS" )
    public void Regression_Scenario_CP_15_Transaction_02_PCNM() throws Exception {
        excelFileName = "Regression_Scenario_CP_15";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
