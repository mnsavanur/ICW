...
public class Smoke_Scenario_CP_02
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Smoke_Scenario_CP_02_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Smoke_Scenario_CP_02";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Smoke_Scenario_CP_02_Transaction_01_NBQUNBIS")
    public void Smoke_Scenario_CP_02_Transaction_02_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Smoke_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Smoke_Scenario_CP_02_Transaction_02_CANC")
    public void Smoke_Scenario_CP_02_Transaction_03_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Smoke_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
