...
public class Regression_Scenario_CP_18
    ...
    public void Regression_Scenario_CP_18_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_18";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theStatePage().theUser_().enterStatesDetails(testDataAsMap);
    ...
    @Test(enabled = true, priority = 1, dependsOnMethods = "Regression_Scenario_CP_18_Transaction_01_NBQUNBIS")
    public void Regression_Scenario_CP_18_Transaction_02_PCNM() throws Exception {
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            sanNumber = whileViewing().theCommonInfoPage().theUser_().fetchSan();
            whileViewing().thePropertyPage().theUser_().enterPropertyPolicyInfo(testDataAsMap);
            whileViewing().theLocationsPage().theUser_().CPCoveragesModifiedPCNM(testDataAsMap);
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_CP_18_Transaction_02_PCNM")
    public void Regression_Scenario_CP_18_Transaction_03_PCNT() throws Exception {
        excelFileName = "Regression_Scenario_CP_18";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
