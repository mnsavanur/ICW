...
public class Regression_Scenario_CP_06
    ...
    public void Regression_Scenario_CP_06_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_06";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_06_Transaction_01_NBQUNBIS" )
    public void Regression_Scenario_CP_06_Transaction_02_PCNM() throws Exception {
        excelFileName = "Regression_Scenario_CP_06";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_CP_06_Transaction_02_PCNM")
    public void Regression_Scenario_CP_06_Transaction_03_PCNT() throws Exception {
        excelFileName = "Regression_Scenario_CP_06";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
