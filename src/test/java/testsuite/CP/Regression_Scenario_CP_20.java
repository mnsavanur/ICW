...
public class Regression_Scenario_CP_20
    ...
    public void Regression_Scenario_CP_20_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_20";
    ...
    @Test(enabled = true, priority = 1, dependsOnMethods = "Regression_Scenario_CP_20_Transaction_01_NBQUNBIS")
    public void Regression_Scenario_CP_20_Transaction_02_CANC() throws Exception {
        excelFileName = "Regression_Scenario_CP_20";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_CP_20_Transaction_02_CANC")
    public void Regression_Scenario_CP_20_Transaction_03_REISSUE() throws Exception {
        excelFileName = "Regression_Scenario_CP_20";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
