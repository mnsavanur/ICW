...
public class Regression_Scenario_CP_17
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_CP_17_Transaction_01_NBIS() throws Exception {
        initialTransactionName = "NBIS";
        excelFileName = "Regression_Scenario_CP_17";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CP_17_Transaction_01_NBIS")
    public void Regression_Scenario_CP_17_Transaction_02_CANC() throws Exception {
        excelFileName = "Regression_Scenario_CP_17";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_CP_17_Transaction_02_CANC")
    public void Regression_Scenario_CP_17_Transaction_03_CARS() throws Exception {
        excelFileName = "Regression_Scenario_CP_17";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
